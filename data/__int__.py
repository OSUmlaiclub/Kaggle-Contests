...
# reading data
# TODO: can't read the data
# ERROR:
#   tf.data
label, image = read_and_decode_single_example(["/raw/training/training10_0.tfrecords", "../input/training10_1/training10_1.tfrecords"])
images_batch, labels_batch = tf.train.batch([image, label], batch_size=16, capacity=2000)
global_step = tf.Variable(0, trainable=False)

# view data
# TODO: can't view the data
# ERROR:
#   CPU settings, use GPU or updated version for CPU
